...
<html lang="en">
    ...
    <body>
        ...
        const monthlyDonationsLabels = <?php echo json_encode(array_column($monthly_donations, 'month')); ?>;
        ...
        const monthlyAdoptionsLabels = <?php echo json_encode(array_column($monthly_adoptions, 'month')); ?>;
        ...
        const donationTypesLabels = <?php echo json_encode(array_column($donation_types, 'type')); ?>;
